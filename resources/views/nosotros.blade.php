...
<head>
    ...
    <title>Sobre-Nosotros - Tienda</title>
    <style>
        ...
        .cuerpo-nosotros { display: flex; justify-content: space-around; padding: 20px; background-color: #f9f9f9; }
        .lo-que-ofrecemos, .nuestro-equipo { background-color: white; padding: 20px; border-radius: 5px; box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1); width: 45%; }
        .nuestro-equipo { justify-content: space-around; }
        .contenedor-persona{  display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px; }
        h1 { font-size: 24px; color: #333; margin-bottom: 10px; text-align: center; }
        h2 { font-size: 20px; color: #333; margin-bottom: 10px; text-align: center; }
...
<body>
    ...
    <section>
        <div class="cuerpo-nosotros">
            <div class="lo-que-ofrecemos">
                <h1>Lo que ofrecemos</h1>
                <h2>Productos de alta calidad de las mejores marcas</h2>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laudantium aut ratione earum? Porro sint consequatur ad repellat mollitia libero ex. Debitis delectus fugit iste aliquid nulla deserunt consectetur molestias repellat.</p>
